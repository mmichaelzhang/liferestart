...
class App{
    ...
    initPages() {
        ...
        <div id="main">
            ...
            <button id="next" class="mainbtn" style="top:auto; bottom:0.1em">请随意选择=-=</button>
        </div>
        `);
        ...
        talentPage
            ...
            .click(()=>{
                ...
                //     return;
                // }
                this.#totalMax = 1600 + this.#life.getTalentAllocationAddition(Array.from(this.#talentSelected).map(({id})=>id));
        ...
        groups.CHR = getBtnGroups("颜值", 0, 40); // 颜值 charm CHR
        groups.INT = getBtnGroups("智力", 0, 2000); // 智力 intelligence INT
        groups.STR = getBtnGroups("体质", 0, 2000); // 体质 strength STR
        groups.MNY = getBtnGroups("家境", 0, 40); // 家境 money MNY
        groups.SPR = getBtnGroups("家境1", 0, 40); // 家境 money MNY
        // groups.TLT = getBtnGroups("家境2", 0, 40); // 家境 money MNY
